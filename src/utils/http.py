...
class Request:
    ...
    def _create_request(self, method: hdrs.METH_ALL,
        ...
        Args:
            ...
            **kwargs: Rest of aiohttp request kwargs
        ...
        return client().request(method.upper(), url, raise_for_status=raise_for_status, headers=headers, **kwargs)
    ...
    def _validate_response(self) -> None:
        ...
        # Check if validation is a pydantic model
            ...
            # Validate generic types
                ...
                self._validated_data = parse_obj_as(self.validation_model, response)
